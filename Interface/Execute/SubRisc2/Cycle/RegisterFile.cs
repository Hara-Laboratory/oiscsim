...
namespace Interface.Execute.SubRISC2
{
    public class RegisterFile : SyncModuleBase
    {
        ...
        public RegisterFile()
        {
            Entries = new SubRISC2.RegisterFile.EntryElement[EntryCount];
            ...
            PreviousRead0 = new SubRISC2.RegisterFile.ReadCommand()
            {
                Enabled = false,
                No = -1
            };
            PreviousRead1 = new SubRISC2.RegisterFile.ReadCommand()
            {
                Enabled = false,
                No = -1
            };
